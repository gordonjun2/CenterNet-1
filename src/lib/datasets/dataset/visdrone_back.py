...
class VISDRONE(data.Dataset):
    ...
    def __init__(self, opt, split):
        ...
        self.max_objs = 128
        self.class_name = ['ignored regions', 'pedestrian', 'person', 'bicycle', 'car',
        ...
        self.images = os.listdir('/media/dh/Data/VisDrone2019-DET-train/images')
        self.num_samples = len(self.images)

        if split == 'val':
            self.images = os.listdir('/media/dh/Data/VisDrone2019-DET-val/images')
            self.num_samples = len(self.images)
