...
def make_up_layer(inp_dim, out_dim, modules):
    growth_rate = inp_dim / 2
    ...
    for j in range(modules):
        ...
        if j != modules - 1:
            ...
            layers.append(TransitionBlock(in_planes = in_planes, out_planes = out_dim, dropRate = dropRate))
...
class kp_module(nn.Module):
    def __init__(
        ...
        self.low1 = make_up_layer(curr_dim, next_dim, curr_mod)
        ...
        self.low3 = make_up_layer(next_dim, curr_dim, curr_mod)
...
def get_small_hourglass_net_all_dense(num_layers, heads, head_conv):
